...
export default function EmergencyBar() {
  ...
  return (
    <aside aria-label="Aviso Institucional" className="bg-[#121924] border-b border-saf-border/80 text-xs py-2 px-4 relative z-50">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-semibold text-saf-light tracking-wide flex items-center gap-1.5 uppercase text-[11px]">
            <Building2 className="w-3.5 h-3.5 text-saf-gold inline-block" />
            SAF Advocacia e Consultoria &bull; Direito Imobiliário &amp; Atuação Jurídica Integral
          </span>
          <span className="hidden md:inline text-saf-subtle">•</span>
          <span className="hidden md:inline text-saf-muted">
            Assessoria imobiliária especializada, defesa criminal e consultoria multidisciplinar.
          </span>
        </div>
